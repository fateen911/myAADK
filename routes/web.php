...
Route::middleware(['auth', 'level:1,3'])->group(function () {
    ...
    // PELAPORAN - PENTADBIR & BRPP - KESELURUHAN
    Route::get('/pelaporan/modal-kepulihan', [PelaporanController::class, 'analisisKesleuruhan'])->name('pelaporan.analisis.keseluruhan');
