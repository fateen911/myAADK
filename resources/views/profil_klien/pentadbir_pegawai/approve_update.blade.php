            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                        <!--begin::Form-->
                        <form method="post" action="{{ route('pegawai.approveUpdate', ['id' => $updateRequest->id]) }}">
                            @csrf
                            @method('PATCH')
                            
                            <div class="row mb-7">
                                <div class="col-md-9 offset-md-3">
                                    <h2>Luluskan Permintaan Kemaskini Maklumat Peribadi Klien</h2>
                                </div>
                            </div>
                    
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-start">
                                    <label class="fs-6 fw-semibold form-label mt-3">Nama Penuh</label>
                                </div>
                                <div class="col-md-7">
                                    <input type="text" class="form-control form-control-solid readonly-input" name="nama" value="{{ $requestedData['nama'] }}" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control form-control-solid readonly-input" name="no_kp" value="{{ $requestedData['no_kp'] }}" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-md-3 text-md-start">
                                    <label class="fs-6 fw-semibold form-label mt-3">Alamat E-mel</label>
                                </div>
                                <div class="col-md-7">
                                    <input type="text" class="form-control form-control-solid" name="emel" value="{{ $requestedData['emel'] }}" />
                                </div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                ...
                                <div class="col-md-7">
                                    <textarea class="form-control form-control-solid" name="alamat_rumah">{{ $requestedData['alamat_rumah'] }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row fv-row mb-7">
                                ...
                                <div class="col-md-7">
                                    <div class="w-100">
                                        <!--begin::Select2-->
                                        <input type="text" maxlength="5" class="form-control form-control-solid" id="poskod" name="poskod" placeholder="" value="{{ $requestedData['poskod'] }}" />
                                        <!--end::Select2-->
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <select class="form-select form-select-solid" id="daerah" name="daerah" data-control="select2" data-hide-search="true" data-placeholder="Pilih daerah">
                                            ...
                                            @foreach ($daerah as $item)
                                                <option value="{{ $item->id }}" {{ $requestedData['daerah'] == $item->id ? 'selected' : '' }}>{{ $item->daerah }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <select class="form-select form-select-solid" id="negeri" name="negeri" data-control="select2" data-hide-search="true" data-placeholder="Pilih negeri">
                                            ...
                                            @foreach ($negeri as $item)
                                                <option value="{{ $item->id }}" {{ $requestedData['negeri'] == $item->id ? 'selected' : '' }}>{{ $item->negeri }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                ...
                                <div class="col-md-7">
                                    <div class="w-100">
                                        ...
                                        <select class="form-select form-select-solid" id="tahap_pendidikan" name="tahap_pendidikan" data-control="select2" data-hide-search="true" data-placeholder="Pilih Tahap Pendidikan">
                                            ...
                                            <option value="PENDIDIKAN RENDAH" {{ $requestedData['tahap_pendidikan'] == 'PENDIDIKAN RENDAH' ? 'selected' : '' }}>PENDIDIKAN RENDAH</option>
                                            <option value="PENDIDIKAN MENENGAH" {{ $requestedData['tahap_pendidikan'] == 'PENDIDIKAN MENENGAH' ? 'selected' : '' }}>PENDIDIKAN MENENGAH</option>
                                            <option value="PENGAJIAN TINGGI" {{ $requestedData['tahap_pendidikan'] == 'PENGAJIAN TINGGI' ? 'selected' : '' }}>PENGAJIAN TINGGI</option>
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                </div>
                            ...
                            <div class="row fv-row mb-7">
                                ...
                                <div class="col-md-7">
                                    <select class="form-select form-select-solid" name="status">
                                        <option value="Lulus" {{ $updateRequest->status == 'Lulus' ? 'selected' : '' }}>Lulus</option>
                                        <option value="Ditolak" {{ $updateRequest->status == 'Ditolak' ? 'selected' : '' }}>Ditolak</option>
                                    </select>
                                </div>
                            </div>
