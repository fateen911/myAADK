                    ...
                    <table style="width:100%; border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; padding: 0 5px;">Sangat Setuju</th>
                                <th style="text-align: center; padding: 0 5px;">Setuju</th>
                                <th style="text-align: center; padding: 0 5px;">Tidak Setuju</th>
                                <th style="text-align: center; padding: 0 5px;">Sangat Tidak Setuju</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($questions as $question)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <input type="radio" name="answer[{{ $question->id }}]" value="4" {{ $savedAnswer == 4 ? 'checked' : '' }}>
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="radio" name="answer[{{ $question->id }}]" value="3" {{ $savedAnswer == 3 ? 'checked' : '' }}>
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="radio" name="answer[{{ $question->id }}]" value="2" {{ $savedAnswer == 2 ? 'checked' : '' }}>
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="radio" name="answer[{{ $question->id }}]" value="1" {{ $savedAnswer == 1 ? 'checked' : '' }}>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
