<x-guest-layout>
    ...
    <form method="POST" action="{{ route('store.reset.password.challenge') }}" data-kt-redirect-url="{{ route('login') }}">
        @csrf
        ...
        <small class="text-gray-600">Minimum 6 aksara, dan kombinasi huruf besar, huruf kecil, nombor dan simbol.</small>
