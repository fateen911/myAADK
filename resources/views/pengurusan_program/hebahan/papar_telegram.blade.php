...
<body>
<form method="post" action="{{url('/pengurusan-program/hebahan/telegram/'.$program->id)}}">
    @csrf
    <div class="h-500px">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-icon btn-primary mx-2 btn-sm" id="share-button"><i class="bi bi-telegram fs-3 text-white"></i></button>
    </div>
