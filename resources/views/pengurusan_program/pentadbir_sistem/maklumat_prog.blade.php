                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-title">
                                ...
                                <a href="{{url('/pengurusan-program/pentadbir-sistem/padam-prog/'.$program->id)}}" id="padam" data-link="{{url('/pengurusan-program/pentadbir-sistem/padam-prog/'.$program->id)}}" class="btn btn-sm btn-danger btn-active-secondary">
