                        ...
                        <div class="card-header">
                            ...
                            @if($program->status == "BELUM SELESAI")
                                <div class="card-title">
                                    ...
                                    <a href="{{url('/pengurusan-program/pentadbir-sistem/batal-prog/'.$program->id)}}" id="padam" data-link="{{url('/pengurusan-program/pentadbir-sistem/padam-prog/'.$program->id)}}" class="btn btn-sm btn-danger btn-active-secondary">
