...
-->
                    ...
                    <div class="w-md-350px mb-2 mx-auto fw-semibold fs-6 mb-7 ">
                        ...
                        <br>
                        <hr>
                        <a href="{{url('/pengurusan-program/klien/pengesahan-kehadiran/'.$program->encrypted_id . '?version=' . $program->version)}}">Klik sini untuk membuat maklum balas kehadiran yang lain.</a>
                    </div>
                    <!--end::Text-->
                </div>
            </div>
