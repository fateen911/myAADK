        ...
        <div class="d-md-flex flex-md-column flex-md-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <!--begin::Form-->
                    <form id="program_form" class="form d-flex flex-column flex-lg-row" action="{{ url('/pengurusan-program/pegawai-aadk/post-daftar-prog') }}" method="POST">
                        @csrf
                        <!--begin::Main column-->
                                        ...
                                        <div class="form d-flex flex-column flex-lg-row mb-6">
                                            <div class="d-flex flex-column flex-row-fluid w-100 w-lg-300px me-lg-10">
                                                ...
                                                <select id="negeri" class="form-select" name="negeri" required>
                                                    ...
                                                    @endphp
                                                    <option value="{{$negeri->id}}" selected>{{ $displayName }}</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid w-100 w-lg-300px">
                                                ...
                                                @elseif($tahap == '5')
                                                    <select class="form-select" name="daerah" required>
                                                        <option value="{{$daerah->kod}}" selected>{{ \Illuminate\Support\Str::replaceFirst('AADK DAERAH', '', $daerah->daerah) }}</option>
                                                    </select>
                                                @endif
                                            </div>
                                        </div>
