                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-4">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color: #581378;">
                                    ...
                                    <div class="m-0">
                                        <a href="{{ route('senarai-klien-daerah') }}">
                                            <span id="belumKemaskiniCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$telahKemaskiniDaerah}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-4">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color: #138aca;">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0">
                                        <a href="{{ route('senarai-permohonan-klien-daerah') }}">
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:#6f1d1b">
                                    ...
                                    <div class="m-0">
                                        <a href={{route('maklum.balas.kepulihan.daerah')}}>
                                            <span id="tidakMenjawabCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$tidak_menjawab_lebih_6bulan_daerah}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:crimson">
                                    ...
                                    <div class="m-0">
                                        <a href={{route('maklum.balas.kepulihan.daerah')}}>
                                            <span id="tidakMenjawabCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$tidak_pernah_menjawab_daerah}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color: green;">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0">
                                        <a href="{{ route('maklum.balas.kepulihan.daerah', ['status' => 'Selesai', 'tahap_kepulihan_id' => '4']) }}">
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body bg-warning">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0">
                                        <a href="{{ route('maklum.balas.kepulihan.daerah', ['status' => 'Selesai', 'tahap_kepulihan_id' => '3']) }}">
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:darkorange;">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0">
                                        <a href="{{ route('maklum.balas.kepulihan.daerah', ['status' => 'Selesai', 'tahap_kepulihan_id' => '2']) }}">
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color: red;">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="m-0">
                                        <a href="{{ route('maklum.balas.kepulihan.daerah', ['status' => 'Selesai', 'tahap_kepulihan_id' => '1']) }}">
