...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Laman Utama Testing GitBucket</li>
        <!--end::Item-->
        <!--begin::Item-->
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-4">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:palevioletred">
                                    ...
                                    <div class="m-0">
                                        <a href={{ route('senarai-pengguna') }}>
                                            <span id="klienCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$jumlah1}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-4">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color: #581378;">
                                    ...
                                    <div class="m-0">
                                        <a href="{{ route('senarai-klien') }}">
                                            <span id="belumKemaskiniCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$telahKemaskini}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                        ...
                        <div class="row g-3 g-lg-6" style="text-align: center;">
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:#6f1d1b">
                                    ...
                                    <div class="m-0">
                                        <a href={{route('maklum.balas.kepulihan')}}>
                                            <span id="tidakMenjawabCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$tidak_menjawab_lebih_6bulan}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
                            ...
                            <div class="col-3">
                                ...
                                <div class="px-6 pt-5 card-rounded h-150px w-100 card theme-dark-bg-body" style="background-color:crimson">
                                    ...
                                    <div class="m-0">
                                        <a href={{route('maklum.balas.kepulihan')}}>
                                            <span id="tidakMenjawabCount" class="text-white fw-bolder d-block fs-4x lh-1 ls-n1 mb-1">{{$tidak_pernah_menjawab}}</span>
                                            <span class="text-white fw-bold fs-7">Klik untuk Lihat</span>
                                        </a>
                                    </div>
                                    <!--end::Stats-->
