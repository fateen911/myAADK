...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    ...
    <div class="mb-0" id="home">
        ...
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-light landing-img">
            ...
            <!--begin::Landing hero-->
            <div class="d-flex w-100 min-h-350px min-h-lg-500px p-10">
                <!--end::Heading-->
                <div class="text-left mb-5 mb-lg-10 py-10 py-lg-20 mx-20 w-40">
                ...
                <!--end::Heading-->
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20  my-auto mx-auto w-40">
                    @include('auth.login')
                </div>
            </div>
            <!--end::Landing hero-->
