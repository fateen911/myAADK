    ...
    <div class="card shadow-sm p-5 mx-w-300 mx-w-450 mw-r-700">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <iframe title="mysupport01" width="800" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiMWQ2NmIyOTktN2NmNi00ZGExLWE0NTAtZjA5NWY4MmY2ODlhIiwidCI6IjBlMGRiMmFkLWM0MTYtNDdjNy04OGVjLWNlYWM0ZWU3Njc2NyIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
            </div>
