    ...
    <script>
        $(document).ready(function () {
            ...
            $("#export-excel3").click(function (e) {
                ...
                window.location.href = "/pegawai-negeri/pelaporan/excel/belum-selesai-menjawab?" + query;
            });
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#export-excel4").click(function (e) {
                ...
                window.location.href = "/pegawai-negeri/pelaporan/excel/tidak-menjawab-lebih-6Bulan?" + query;
            });
