...
{
    // PENTADBIR & BRPP - ANALISIS KESELURUHAN
    public function analisisKesleuruhan()
    {
        ...
        return view('pelaporan.keseluruhan.pentadbir_brpp', compact('notifications', 'unreadCountPD'));
    }
