...
class DaftarPenggunaController extends Controller
{
    ...
    public function pegawaiKemaskiniKlien(Request $request)
    {
        ...
        if ($user) {
            ...
            return redirect()->route('pegawai-daerah.senarai-klien')->with('warning', 'Maklumat akaun klien belum didaftarkan ke dalam sistem.');
        }
    }
    ...
    public function modalDaftarKlienDaerah($id)
    {
        ...
        $klien = app()->environment('local')? viewklienlocal::where('mykad', $id)->first(): KlienView::where('mykad', $id)->first();
