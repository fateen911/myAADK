...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pejabat_pengawasan_klien', function (Blueprint $table) {
            ...
            $table->string('negeri_aadk_asal')->nullable();
            $table->string('daerah_aadk_asal')->nullable();
            $table->string('alamat_rumah_asal')->nullable();
            $table->string('poskod_rumah_asal')->nullable();
            $table->string('negeri_rumah_asal')->nullable();
            $table->string('daerah_rumah_asal')->nullable();
