...
return new class extends Migration
{
    ...
    {
        Schema::create('pengesahan_kehadiran_program', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('program_id');
            $table->unsignedBigInteger('klien_id');
            $table->datetime('tarikh_pengesahan');
    ...
    {
        Schema::table('pengesahan_kehadiran_program', function (Blueprint $table) {
